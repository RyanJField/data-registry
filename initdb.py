...
ObjectComponent.objects.create(updated_by=user, object=o_repo_prob, name='symptom-probability')

ObjectComponent.objects.create(updated_by=user, object=o_repo_delay, name='symptom-probability')

ObjectComponent.objects.create(updated_by=user, object=o_repo_infect, name='symptom-probability')

ObjectComponent.objects.create(updated_by=user, object=o_repo_latent, name='symptom-probability')

ObjectComponent.objects.create(updated_by=user, object=o_repo_asym, name='symptom-probability')

ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/covid_related_deaths/persons/by_agegroup')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/covid_related_deaths/persons/all_ages')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/covid_related_deaths/males/by_agegroup')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/covid_related_deaths/males/all_ages')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/covid_related_deaths/females/by_agegroup')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/covid_related_deaths/females/all_ages')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/all_deaths/persons/by_agegroup')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/all_deaths/persons/averaged_over_5years')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/all_deaths/persons/all_ages')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/all_deaths/males/by_agegroup')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/all_deaths/males/all_ages')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/all_deaths/females/by_agegroup')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='scotland/per_week/all_deaths/females/all_ages')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='nhs_health_board/per_week/covid_related_deaths')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='nhs_health_board/per_week/all_deaths')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='nhs_health_board/per_location/covid_related_deaths')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='nhs_health_board/per_location/all_deaths')
...
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='council_area/per_week/covid_related_deaths')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='council_area/per_week/all_deaths')
ObjectComponent.objects.create(updated_by=user, object=o_boy_mort_h5, name='council_area/per_location/covid_related_deaths')

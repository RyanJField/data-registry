...
urlpatterns = [
    ...
    path('data_product/<str:namespace>:<str:data_product_name>@<str:version>', views.data_product),
    path('external_object/<path:doi>:<str:title>@<str:version>', views.external_object),
